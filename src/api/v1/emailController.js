...
const emailService = require("../../service/node_mailer_service");
...
const signUpWithEmailandPassword = async (req, res) => {
  try {
    ...
    const passwordEmail = await emailService.sendEmail(obj?.name, obj.email, "Your Sri Rama Navami Login Details", randomPassword,"welcome_email");
